...
const Cards = () => {
    ...
    return (
        <div>
            ...
            <div className={'cardContainer'} style={{background: '#ececec', padding: '30px'}}>
                <Card
                    title={'无边框卡片'}
                    bordered={false}
                >
            ...
            <div className={'cardContainer'}>
                <Card
                    title={'封面式卡片'}
                    cover={<img height={300} alt={'封面图片'} src={'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2858624356,1431118860&fm=26&gp=0.jpg'}/>}
                >
                    <Card.Meta
                        avatar={<Avatar size={100} src={avatarImg}/>}
                        title={'这是一个美妙的故事'}
                        description={'这是一个令人难忘的美好故事，它发生在一个月光柔和的夜晚。他和她相恋了！'}
                    />
                </Card>
            </div>
            <div className={'cardContainer'}>
